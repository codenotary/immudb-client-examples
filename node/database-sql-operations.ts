...
(async () => {
  try {
    ...
    const sqlExecCreateTableReq: Parameters.SQLExec = { sql: `create table ${ tableName } (id integer, name varchar, primary key id);` }
    ...
    const sqlExecInsertRecordReq: Parameters.SQLExec = {
    ...
    const sqlQueryReq: Parameters.SQLQuery = {
